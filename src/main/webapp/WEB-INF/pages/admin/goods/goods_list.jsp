            ...
            <form class="form-horizontal" id="myeditform" name="myform">
             <input type="hidden"  name="id" value=""/>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" name="catelogId" style="margin-top: 8px;"/>
					</div>
				</div>
				<div class="form-group">
					 <label class="col-sm-4 control-label" >原价:</label>
					<div class="col-sm-8">
						<input type="text" class="form-control"  name="price" style="margin-top: 8px;"/>
					</div>
				</div>
				<div class="form-group">
					 <label class="col-sm-4 control-label" >售价:</label>
					<div class="col-sm-8">
						<input type="text" class="form-control"  name="realPrice" style="margin-top: 8px;"/>
					</div>
				</div>
				<div class="form-group">
					 <label class="col-sm-4 control-label" >创建时间:</label>
					<div class="col-sm-8">
						 <input  type="text"  name="startTime" class="form-control form_datetime" style="margin-top: 8px;">
					</div>
				</div>
				<div class="form-group">
					 <label class="col-sm-4 control-label" >描述:</label>
					<div class="col-sm-8">
					<textarea rows="3" cols="20"  name="describle" style="margin-top: 8px;width:365px">
					</textarea>
					</div>
				</div>
				<div class="form-group">
...
<script type="text/javascript">
		...
		/* 保存 */
		function doSave(){
		    var str = $('#myeditform').serialize();
            str = decodeURIComponent(str,true); //关键点
            //console.log(str);
			$.ajax({
